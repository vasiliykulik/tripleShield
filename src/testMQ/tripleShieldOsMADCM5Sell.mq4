...
int iteration;
/*
Implement Open Order operation base on DCM5 for Sell operation
*/
void OnTick(void)
  {
   ...
   if(total<1)
     {
      ...
      if(
            ...
            */
            buy ==1 &&
            doubleCriterionTheTimeOfEntryM5 == 0
      ...
      if(
           ...
           */
           sell ==1 &&
           doubleCriterionTheTimeOfEntryM5 == 1
